...
| Conversation unavailable | The saved provider thread is missing, not necessarily the broker. Use **Start new conversation** after reader confirmation or restore an available archive; preserve the old reference and native histories |
