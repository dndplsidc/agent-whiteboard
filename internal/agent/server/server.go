...
const (
	CommandsPath            = protocol.Namespace + "/commands"
...
type Backend interface {
	Connect(context.Context, string, protocol.Command) (broker.BrowserConnection, error)
}
...
type ImageBackend interface {
	Stage(context.Context, attachment.StageRequest) (attachment.Staged, error)
	Read(context.Context, attachment.ReadRequest) (attachment.Image, error)
	DeleteStaged(context.Context, attachment.DeleteRequest) error
}
