...
var imageReadHeaders = []string{
	strings.ToLower(protocol.APIVersionHeader),
	strings.ToLower(protocol.ClientIDHeader),
	strings.ToLower(protocol.ConversationIDHeader),
}
var imageUploadHeaders = append(append([]string{}, imageReadHeaders...), "content-type", strings.ToLower(protocol.ProviderHeader), strings.ToLower(protocol.ImagePurposeHeader))
