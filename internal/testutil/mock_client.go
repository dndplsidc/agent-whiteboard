...
func (_mock *MockClient) CreateImages(context1 context.Context, files []webapi.File, n *int64) ([]webapi.Resource, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, []webapi.File, *int64) ([]webapi.Resource, error)); ok {
		return returnFunc(context1, files, n)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, []webapi.File, *int64) []webapi.Resource); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, []webapi.File, *int64) error); ok {
...
func (_c *MockClient_CreateImages_Call) Run(run func(context1 context.Context, files []webapi.File, n *int64)) *MockClient_CreateImages_Call {
...
func (_c *MockClient_CreateImages_Call) Return(resources []webapi.Resource, err error) *MockClient_CreateImages_Call {
	_c.Call.Return(resources, err)
	return _c
}

func (_c *MockClient_CreateImages_Call) RunAndReturn(run func(context1 context.Context, files []webapi.File, n *int64) ([]webapi.Resource, error)) *MockClient_CreateImages_Call {
	_c.Call.Return(run)
	return _c
}

// CreateMarkdown provides a mock function for the type MockClient
func (_mock *MockClient) CreateMarkdown(context1 context.Context, file webapi.File, file1 webapi.File, n *int64) (webapi.Resource, error) {
...
func (_c *MockClient_CreateMarkdown_Call) Run(run func(context1 context.Context, file webapi.File, file1 webapi.File, n *int64)) *MockClient_CreateMarkdown_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockClient_CreateMarkdown_Call) Return(resource webapi.Resource, err error) *MockClient_CreateMarkdown_Call {
	_c.Call.Return(resource, err)
	return _c
}

func (_c *MockClient_CreateMarkdown_Call) RunAndReturn(run func(context1 context.Context, file webapi.File, file1 webapi.File, n *int64) (webapi.Resource, error)) *MockClient_CreateMarkdown_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockClient) DeleteWhiteboard(context1 context.Context, whiteboardKind webapi.WhiteboardKind, s string) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, webapi.WhiteboardKind, string) error); ok {
...
func (_c *MockClient_DeleteWhiteboard_Call) Run(run func(context1 context.Context, whiteboardKind webapi.WhiteboardKind, s string)) *MockClient_DeleteWhiteboard_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_mock *MockClient) GetMarkdown(context1 context.Context, s string) (webapi.MarkdownResponse, error) {
	ret := _mock.Called(context1, s)
	...
	var r0 webapi.MarkdownResponse
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (webapi.MarkdownResponse, error)); ok {
		return returnFunc(context1, s)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) webapi.MarkdownResponse); ok {
		r0 = returnFunc(context1, s)
	} else {
		r0 = ret.Get(0).(webapi.MarkdownResponse)
	}
...
func (_c *MockClient_GetMarkdown_Call) Return(markdownResponse webapi.MarkdownResponse, err error) *MockClient_GetMarkdown_Call {
	_c.Call.Return(markdownResponse, err)
	return _c
}

func (_c *MockClient_GetMarkdown_Call) RunAndReturn(run func(context1 context.Context, s string) (webapi.MarkdownResponse, error)) *MockClient_GetMarkdown_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockClient) UpdateImage(context1 context.Context, s string, file webapi.File, n *int64) (webapi.Resource, error) {
	...
	var r0 webapi.Resource
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, webapi.File, *int64) (webapi.Resource, error)); ok {
		return returnFunc(context1, s, file, n)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, webapi.File, *int64) webapi.Resource); ok {
		r0 = returnFunc(context1, s, file, n)
	} else {
		r0 = ret.Get(0).(webapi.Resource)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, webapi.File, *int64) error); ok {
...
func (_c *MockClient_UpdateImage_Call) Run(run func(context1 context.Context, s string, file webapi.File, n *int64)) *MockClient_UpdateImage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockClient_UpdateImage_Call) Return(resource webapi.Resource, err error) *MockClient_UpdateImage_Call {
	_c.Call.Return(resource, err)
	return _c
}

func (_c *MockClient_UpdateImage_Call) RunAndReturn(run func(context1 context.Context, s string, file webapi.File, n *int64) (webapi.Resource, error)) *MockClient_UpdateImage_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateMarkdown provides a mock function for the type MockClient
func (_mock *MockClient) UpdateMarkdown(context1 context.Context, s string, file webapi.File, file1 webapi.File, n *int64) (webapi.Resource, error) {
...
func (_c *MockClient_UpdateMarkdown_Call) Run(run func(context1 context.Context, s string, file webapi.File, file1 webapi.File, n *int64)) *MockClient_UpdateMarkdown_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockClient_UpdateMarkdown_Call) Return(resource webapi.Resource, err error) *MockClient_UpdateMarkdown_Call {
	_c.Call.Return(resource, err)
	return _c
}
